...
* and 1 otherwise.
**************************************************/
__host__ __device__ int polyvecl_chknorm(const polyvecl *v, int32_t bound)  {
  unsigned int i;
...
* and 1 otherwise.
**************************************************/
__host__ __device__ int polyveck_chknorm(const polyveck *v, int32_t bound) {
  unsigned int i;
...
**************************************************/
__host__ __device__ void polyveck_use_hint(polyveck *w, const polyveck *u, const polyveck *h) {
  unsigned int i;
