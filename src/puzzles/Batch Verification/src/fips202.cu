...
**************************************************/
__host__ __device__ static uint64_t load64(const uint8_t x[8]) {
  unsigned int i;
  uint64_t r = 0;
...
**************************************************/
__host__ __device__ static void store64(uint8_t x[8], uint64_t u) {
  unsigned int i;
...
__ROMQ const uint64_t KeccakF_RoundConstants[NROUNDS] = {
...
**************************************************/
__host__ __device__ static void KeccakF1600_StatePermute(uint64_t state[25])
{
        int round;
...
**************************************************/
__host__ __device__ static void keccak_init(uint64_t s[25])
{
  unsigned int i;
  for(i=0;i<25;i++)
    s[i] = 0;
...
**************************************************/
__host__ __device__ static unsigned int keccak_absorb(uint64_t s[25],
                                  unsigned int pos,
                                  unsigned int r,
                                  const uint8_t *in,
                                  size_t inlen)
...
**************************************************/
__host__ __device__ static void keccak_finalize(uint64_t s[25], unsigned int pos, unsigned int r, uint8_t p)
{
...
* Returns new position pos in current block
**************************************************/
__host__ __device__ static unsigned int keccak_squeeze(uint8_t *out,
                                   size_t outlen,
                                   uint64_t s[25],
                                   unsigned int pos,
                                   unsigned int r)
...
**************************************************/
__host__ __device__ static void keccak_absorb_once(uint64_t s[25],
                               unsigned int r,
                               const uint8_t *in,
                               size_t inlen,
                               uint8_t p)
...
*              - unsigned int r: rate in bytes (e.g., 168 for SHAKE128)
**************************************************/
__host__ __device__ static void keccak_squeezeblocks(uint8_t *out,
                                 size_t nblocks,
                                 uint64_t s[25],
                                 unsigned int r)
{
